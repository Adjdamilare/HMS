...
public class RoomDetailsController {
    ...
    public String newRoom(Model model) {
        String roomId = roomService.generateNextRoomId();
        model.addAttribute("title", "RoomDetails");
        model.addAttribute("entityPath", "roomDetails");
        model.addAttribute("fields", getRoomDetailsFields());
        model.addAttribute("idValue", roomId);
    ...
    public String editRoomDetails(@PathVariable String id, Model model) {
        ...
        List<Field> fields = getRoomDetailsFields();
        model.addAttribute("title", "Room Details");
        model.addAttribute("entityPath", "roomDetails");
